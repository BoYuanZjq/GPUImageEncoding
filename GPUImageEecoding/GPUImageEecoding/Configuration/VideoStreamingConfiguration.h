...
typedef NS_ENUM(NSInteger, LMCaptureDevicePosition) {
    LMCaptureDevicePositionBack                = 1,
    LMCaptureDevicePositionFront               = 2
};
...
@interface VideoStreamingConfiguration : NSObject<NSCoding,NSCopying>
...
///< 方向
@property (nonatomic, assign) LMCaptureDevicePosition capturePosition;
